...
### Package managers
```
am, apk, brew, Chocolatey, dpkg, emerge, eopkg, Flatpak, Guix, linglong, lpkg, lpkgbuild, MacPorts, nix, opkg, Pacman, pacstall, paludis, pkg, pkgtool, rpm, scoop, Snap, sorcery, winget (disabled by default), xbps
```
